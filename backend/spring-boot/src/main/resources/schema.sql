...
-- Collection Items table (Many-to-Many: Collections <-> Garments)
...
-- Likes table (Likes on garments, avatars, or try-on sessions)
...
CREATE INDEX IF NOT EXISTS idx_avatars_processing_status ON avatars(processing_status);

-- Garment Categories
CREATE INDEX IF NOT EXISTS idx_garment_categories_parent_id ON garment_categories(parent_id);
CREATE INDEX IF NOT EXISTS idx_garment_categories_slug ON garment_categories(slug);
CREATE INDEX IF NOT EXISTS idx_garment_categories_is_active ON garment_categories(is_active);
...
CREATE INDEX IF NOT EXISTS idx_garments_is_featured ON garments(is_featured);
...
CREATE INDEX IF NOT EXISTS idx_try_on_sessions_avatar_id ON try_on_sessions(avatar_id);
CREATE INDEX IF NOT EXISTS idx_try_on_sessions_garment_id ON try_on_sessions(garment_id);
CREATE INDEX IF NOT EXISTS idx_try_on_sessions_created_at ON try_on_sessions(created_at);
CREATE INDEX IF NOT EXISTS idx_try_on_sessions_is_public ON try_on_sessions(is_public);
